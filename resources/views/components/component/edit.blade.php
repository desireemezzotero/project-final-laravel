<form class="max-w-md mx-auto pt-10 text-white" action="{{route('film.update', $film)}}" method="POST">
  ...
  <div class="relative z-0 w-full mb-5 group">
    <input type="image_url" id="image"  name="image" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0  peer" placeholder=" "  value="{{$film->image}}" required />
