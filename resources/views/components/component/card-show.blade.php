<div class="container max-w-4xl mx-auto p-4 sm:grid sm:grid-cols-2 sm:gap-6 ">
 ...
 <div>
   <img class="object-cover w-full" src="{{asset('storage/' . $film->image)}}" alt="">
 </div>
    ...
    <table class="table-auto">
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="py-2 px-4"> @foreach($film->genres as $genre)
            {{$genre->title_genre}}
           @endforeach</td>
        </tr>
        ...
        @auth
           ...
           <tr class="border-b">
             <td class="font-semibold py-2 px-4">Azioni</td>
             <td class="py-2 px-[100px] flex "> 
               <a href="{{route('film.edit', $film)}}">
                 <svg class="w-[30px] fill-[#ffffff]  hover:fill-amber-300 hover:scale-150 transition-transform duration-300" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
